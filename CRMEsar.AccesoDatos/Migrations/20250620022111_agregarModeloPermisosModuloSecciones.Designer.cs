...
namespace CRMEsar.AccesoDatos.Migrations
{
    ...
    [Migration("20250620022111_agregarModeloPermisosModuloSecciones")]
    partial class agregarModeloPermisosModuloSecciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRMEsar.Models.PermisosModulosSecciones", b =>
                {
                    ...
                    b.Property<Guid?>("ModulosSeccionesseccionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ModulosmoduloId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ModulosSeccionesseccionId");

                    b.HasIndex("ModulosmoduloId");
            ...
            modelBuilder.Entity("CRMEsar.Models.PermisosModulosSecciones", b =>
                {
                    ...
                    b.HasOne("CRMEsar.Models.ModulosSecciones", null)
                        .WithMany("permisosModulosSecciones")
                        .HasForeignKey("ModulosSeccionesseccionId");

                    b.HasOne("CRMEsar.Models.Modulos", null)
                        .WithMany("permisosModulosSecciones")
                        .HasForeignKey("ModulosmoduloId");
                    ...
                    b.HasOne("CRMEsar.Models.ApplicationUser", "applicationUser")
                        .WithMany("permisosModulosSecciones")
