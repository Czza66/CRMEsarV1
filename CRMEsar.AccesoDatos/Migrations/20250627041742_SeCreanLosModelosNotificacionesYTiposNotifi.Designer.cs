...
namespace CRMEsar.AccesoDatos.Migrations
{
    ...
    [Migration("20250627041742_SeCreanLosModelosNotificacionesYTiposNotifi")]
    partial class SeCreanLosModelosNotificacionesYTiposNotifi
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRMEsar.Models.Notificaciones", b =>
                {
                    ...
                    b.Property<Guid>("TipoNotificacionestipoNotificacionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TipoNotificacionestipoNotificacionId");
            ...
            modelBuilder.Entity("CRMEsar.Models.Notificaciones", b =>
                {
                    b.HasOne("CRMEsar.Models.TipoNotificaciones", "TipoNotificaciones")
                        .WithMany()
                        .HasForeignKey("TipoNotificacionestipoNotificacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
